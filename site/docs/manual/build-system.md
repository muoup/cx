...
When interfacing your CX codebase with C code, or any other language which supports C FFI, you may create a "library" target. A library target consists of an object file containing the compiled contents of your code, and a C header autogenerated from the functions defined in the CX Header file (.cxh) you define as your entries.
