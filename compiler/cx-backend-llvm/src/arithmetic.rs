...
pub(crate) fn generate_int_binop<'a, 'b>(
    ...
    let inst_return = match op {
        ...
        MIRIntBinOp::IGT => function_state.builder
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::UGT => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::UGT,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::IGE => function_state.builder
            .build_int_compare(
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::UGE => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::UGE,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::ILT => function_state.builder
            .build_int_compare(
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::ULT => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::ULT,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::ILE => function_state.builder
            .build_int_compare(
        ...
        MIRIntBinOp::ASHR => function_state.builder
            .build_right_shift(
                left_value,
                right_value,
                true,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::LSHR => function_state.builder
            .build_right_shift(
                left_value,
                right_value,
                false,
        ...
        MIRIntBinOp::SHL => function_state.builder
            .build_left_shift(
                left_value,
                right_value,
                crate::instruction::inst_num().as_str()
        ...
        MIRIntBinOp::LAND => function_state.builder
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::LOR => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::NE,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::EQ => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::EQ,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::NE => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::NE,
                left_value,
                right_value,
            ...
            .ok()?
            .as_any_value_enum(),
        MIRIntBinOp::ULE => function_state.builder
            .build_int_compare(
                inkwell::IntPredicate::ULE,
                left_value,
                right_value,
