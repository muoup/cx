...
use cx_log::CXResult;
use cx_thir::{
    thir::{data::THIRFunction, global::MIRGlobalVariable},
    THIRUnit,
};
...
pub fn lower_mir(builder: &mut LMIRBuilder, mir: &THIRUnit) -> CXResult<()> {
...
pub fn generate_function(builder: &mut LMIRBuilder, function: &THIRFunction) -> CXResult<()> {
