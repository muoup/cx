...
use cranelift::prelude::{AbiParam, InstBuilder, Value};
use cranelift_module::{DataDescription, Linkage, Module};
use crate::codegen::codegen::CodegenContext;
use crate::lex::token::OperatorType;
use crate::parse::ast::Expression;

pub(crate) fn codegen_expression(context: &mut CodegenContext, expr: &Expression) -> Option<Value> {
    match expr {
        Expression::Return(expr) => {
            ...
            match expr.as_ref() {
                ...
                _ => {
                    ...
                    // let codegen_expr = context.builder.ins().iconst(ir::types::I64, 0);
        ...
        Expression::IntLiteral(val) => {
            Some(context.builder.ins().iconst(ir::types::I64, *val))
        },
...
fn string_literal(context: &mut CodegenContext, str: &str) -> GlobalValue {
